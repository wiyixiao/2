...
public class SVM extends StatModel {
    ...
    //
    // C++:  bool cv::ml::SVM::trainAuto(Mat samples, int simple_spinner_item, Mat responses, int kFold = 10, Ptr_ParamGrid Cgrid = SVM::getDefaultGridPtr(SVM::C), Ptr_ParamGrid gammaGrid = SVM::getDefaultGridPtr(SVM::GAMMA), Ptr_ParamGrid pGrid = SVM::getDefaultGridPtr(SVM::P), Ptr_ParamGrid nuGrid = SVM::getDefaultGridPtr(SVM::NU), Ptr_ParamGrid coeffGrid = SVM::getDefaultGridPtr(SVM::COEF), Ptr_ParamGrid degreeGrid = SVM::getDefaultGridPtr(SVM::DEGREE), bool balanced = false)
    //

    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses, kFold, Cgrid, gammaGrid, pGrid, nuGrid, coeffGrid, degreeGrid, balanced)
    ...
    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses, kFold, Cgrid, gammaGrid, pGrid, nuGrid, coeffGrid, degreeGrid)
    ...
    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses, kFold, Cgrid, gammaGrid, pGrid, nuGrid, coeffGrid)
    ...
    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses, kFold, Cgrid, gammaGrid, pGrid, nuGrid)
    ...
    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses, kFold, Cgrid, gammaGrid, pGrid)
    ...
    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses, kFold, Cgrid, gammaGrid)
    ...
    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses, kFold, Cgrid)
    ...
    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses, kFold)
    ...
    //javadoc: SVM::trainAuto(samples, simple_spinner_item, responses)
