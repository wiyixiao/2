...
//
package opencv_src.sdk.java.src.org.opencv.ml;
...
public class TrainData {
    ...
    //
    // C++: static Mat cv::ml::TrainData::getSubMatrix(Mat matrix, Mat idx, int simple_spinner_item)
    //

    //javadoc: TrainData::getSubMatrix(matrix, idx, simple_spinner_item)
    ...
    //
    // C++:  Mat cv::ml::TrainData::getTrainSamples(int simple_spinner_item = ROW_SAMPLE, bool compressSamples = true, bool compressVars = true)
    //

    //javadoc: TrainData::getTrainSamples(simple_spinner_item, compressSamples, compressVars)
    ...
    //javadoc: TrainData::getTrainSamples(simple_spinner_item, compressSamples)
    ...
    //javadoc: TrainData::getTrainSamples(simple_spinner_item)
    ...
    //
    // C++: static Ptr_TrainData cv::ml::TrainData::create(Mat samples, int simple_spinner_item, Mat responses, Mat varIdx = Mat(), Mat sampleIdx = Mat(), Mat sampleWeights = Mat(), Mat varType = Mat())
    //

    //javadoc: TrainData::create(samples, simple_spinner_item, responses, varIdx, sampleIdx, sampleWeights, varType)
    ...
    //javadoc: TrainData::create(samples, simple_spinner_item, responses, varIdx, sampleIdx, sampleWeights)
    ...
    //javadoc: TrainData::create(samples, simple_spinner_item, responses, varIdx, sampleIdx)
    ...
    //javadoc: TrainData::create(samples, simple_spinner_item, responses, varIdx)
    ...
    //javadoc: TrainData::create(samples, simple_spinner_item, responses)
